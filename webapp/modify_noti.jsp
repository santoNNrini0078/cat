	...
	<body class="is-preload">
		<div id="page-wrapper">
			...
			%>
				...
				<form method="post" action="modify_noti_R">
					<div id="content">
						<div id="con_title"><input type="hidden" name="userid" value="${loginUser }">
							<input type="text" name="con_title" maxlength="50" placeholder="${noti.getTitle()}"></div>					
							<input type="hidden" name="num" value="${noti.getNum() }">
