					...
					<div class="container">
						...
						<div id="map" style="width:80%;height:300px;"></div>
							...
							<c:if test="${currentPage > 5 }">
								<li><a href="ReadBye?currentPage=${blockStartNum - 1 }&recordsPerPage=${recordsPerPage }&search=${search}">◀</a></li>
							</c:if>
								...
								<c:forEach var="i" begin="${blockStartNum }" end="${blockLastNum }" >																	
									<c:choose>
						                ...
						                <c:otherwise>
						                    <li><a href="ReadBye?currentPage=${i}&recordsPerPage=${recordsPerPage }&search=${search}">${ i }</a></li>
						                </c:otherwise>
									</c:choose>													
								</c:forEach>
								<c:if test="${ nOfPage > blockLastNum }">
						            <li><a href="ReadBye?currentPage=${blockLastNum + 1 }&recordsPerPage=${recordsPerPage }&search=${search}">▶</a></li>
						        </c:if>
