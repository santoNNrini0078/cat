					...
					<div class="container">
						<div id="content">
							...
							<form method="post" action="modify">
								<div id="content">
									<div id="con_title">제목 : ${review.getTitle() },<input type="hidden" name="num" value="${review.getNum() }"> * 작성자 : ${review.getId() }</div>	
		...
		<!-- Scripts -->
			<script>
				...
				if(id==con_id){
					...
					var modi = '<input type="submit" id="modify" value="수정하기" >';
					...
					document.getElementById("modify").value.onclick=function(){
